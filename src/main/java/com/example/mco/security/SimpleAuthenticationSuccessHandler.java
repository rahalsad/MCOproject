 ...
 * 
 * import java.io.IOException; import java.util.Collection; import
 ...
 * 
 * @Component public class SimpleAuthenticationSuccessHandler implements
 * AuthenticationSuccessHandler {
 * 
 * private RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();
 * 
 * @Override public void onAuthenticationSuccess(HttpServletRequest arg0,
 * HttpServletResponse arg1, Authentication authentication) throws IOException,
 * ServletException {
 * 
 * Collection<? extends GrantedAuthority> authorities =
 * authentication.getAuthorities(); authorities.forEach(authority -> {
 * if(authority.getAuthority().equals("ROLE_INITIATEUR")) { try {
 * redirectStrategy.sendRedirect(arg0, arg1, "/fiche"); } catch (Exception e) {
 * // TODO Auto-generated catch block e.printStackTrace(); } } else
 * if(authority.getAuthority().equals("ROLE_ADMIN")) { try {
 * redirectStrategy.sendRedirect(arg0, arg1, "/index"); } catch (Exception e) {
 * // TODO Auto-generated catch block e.printStackTrace(); } } else { throw new
